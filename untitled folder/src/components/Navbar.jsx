      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <a href="#home" className="text-white text-2xl font-black tracking-tight">
            Shivanjay<span className="text-red-500">.</span>
          </a>
        </div>
        ...
        <div className="hidden md:flex space-x-8">
          {navLinks.map((link) => (
            <a 
              key={link.name} 
              href={link.href}
              className="text-white/80 hover:text-white font-medium text-sm relative group transition-colors duration-300"
            >
              {link.name}
        ...
        <div className="hidden md:block">
          <a 
            href="#contact" 
            className="px-6 py-2.5 rounded-full bg-white/10 border border-white/20 text-white font-semibold hover:bg-white hover:text-black transition-all duration-300 backdrop-blur-md text-sm"
          >
            Get In Touch
          </a>
        </div>
