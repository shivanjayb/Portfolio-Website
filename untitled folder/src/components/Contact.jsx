      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-12 md:mb-16 border-b border-white/20 pb-6">
            <div>
              <div className="text-xs font-bold tracking-[0.2em] uppercase opacity-90 font-mono mb-1">
                Reach Shivanjay
              </div>
            ...
            <div className="text-xs font-mono font-bold bg-black/30 px-3.5 py-1.5 rounded-full border border-white/20">
              Available for Engineering Roles
            </div>
          </div>

          {submitted ? (
            <div className="bg-black/40 p-12 rounded-3xl border border-white/20 text-center flex flex-col items-center justify-center my-8">
              <CheckCircle2 className="w-16 h-16 text-white mb-4 animate-bounce" />
              <h3 className="text-2xl font-black text-white mb-2">Message Sent!</h3>
              <p className="text-sm font-mono text-white/80">Thank you for reaching out. Shivanjay will get back to you promptly.</p>
            </div>
          ) : (
                ...
                <div className="flex-1 flex flex-col gap-10">
                  <div className="relative">
                    <input 
                      ...
                      className="w-full bg-transparent border-b border-white/40 pb-3 text-lg focus:outline-none focus:border-white transition-colors placeholder-white font-medium rounded-none text-white"
                    />
                  </div>
                  <div className="relative">
                    <input 
                ...
                <div className="flex-1 flex flex-col">
                  <div className="relative h-full flex flex-col">
                    <textarea 
                      ...
                      className="w-full h-full min-h-[140px] bg-transparent border-b border-white/40 pb-3 text-lg focus:outline-none focus:border-white transition-colors placeholder-white font-medium resize-none rounded-none text-white"
                    ></textarea>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-12 mt-4">
                ...
                <div className="flex-1 flex flex-col gap-8 text-xs text-white/80 font-medium">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                    <p className="max-w-[250px] leading-relaxed opacity-70">
                      Based in Nashik, Maharashtra, India. Open to global remote engineering opportunities.
                    </p>
                    
                    <button 
                      type="submit" 
                      className="px-8 py-3 rounded-full border border-white/40 text-white font-black flex items-center justify-center gap-3 hover:bg-white hover:text-[#ff2a2a] transition-all duration-300 group whitespace-nowrap self-start sm:self-auto shadow-lg"
                    >
                      Send
